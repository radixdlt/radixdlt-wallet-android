...
//            .subscribe(::attemptToRetrieveLastTransactionForAsset, Throwable::printStackTrace)
    ...
    private fun insertTransaction(transactionsEntityOM: TransactionEntity) {
        Timber.tag("ASSETSOM").d("New Transaction")
        // check asset exists
        assetDao.getAsset(transactionsEntityOM.rri)
            .subscribeOn(Schedulers.io())
            .subscribe({
                transactionsDao.insertTransaction(transactionsEntityOM)
    ...
    private fun insertAssets(transactionEntityOMList: MutableList<TransactionEntity>) {
            ...
            assetDao.getAsset(rri)
                ...
                .subscribe({
                    ...
                    if (it is EmptyResultSetException) {
                        ...
                        val sum = sumStoredTransactions(transactionsByRRI)
    ...
    private fun insertAsset(transactionEntityOM: TransactionEntity) {
        ...
        assetDao.insertAsset(assetEntity)
        transactionsDao.insertTransaction(transactionEntityOM)
