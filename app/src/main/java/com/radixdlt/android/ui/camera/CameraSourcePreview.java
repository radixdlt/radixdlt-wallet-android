...
public class CameraSourcePreview extends ViewGroup {
  ...
  private class SurfaceCallback implements SurfaceHolder.Callback {
    ...
    public void surfaceCreated(SurfaceHolder surface) {
      ...
      try {
        ...
        Log.e(TAG, "Do not have permission toAddress start the camera", se);
      } catch (IOException e) {
  ...
  protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
    ...
    // it is usually necessary toAddress slightly oversize the child and toAddress crop off portions along one
    ...
    for (int i = 0; i < getChildCount(); ++i) {
      ...
      // the size toAddress maintain the proper aspect ratio.
