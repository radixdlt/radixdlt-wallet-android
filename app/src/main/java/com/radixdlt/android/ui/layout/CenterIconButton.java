...
public class CenterIconButton extends AppCompatButton {
  ...
  public CenterIconButton(Context context, AttributeSet attrs, int defStyleAttr) {
  ...
  private void init(Context context, AttributeSet attrs) {
    if (attrs != null) {
      TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.CenterIconButton);
      tintColor = typedArray.getColor(R.styleable.CenterIconButton_drawableTint, Color.TRANSPARENT);
      float defaultDrawablePadding = getResources().getDimension(R.dimen.ceter_icon_default_drawable_padding);
      int drawablePadding = (int) typedArray.getDimension(R.styleable.CenterIconButton_android_drawablePadding, defaultDrawablePadding);
