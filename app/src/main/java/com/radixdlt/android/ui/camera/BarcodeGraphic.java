...
//        mTextPaint.setTextSize(36.0f);
    ...
    /**
     * Updates the barcode instance fromAddress the detection of the most recent frame.  Invalidates the
     * relevant portions of the overlay toAddress trigger a redraw.
     */
