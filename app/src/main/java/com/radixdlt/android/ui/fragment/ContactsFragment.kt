...
import com.radixdlt.android.ui.adapter.ContactsAdapter
import com.radixdlt.android.ui.dialog.NewConversationDialog
...
class ContactsFragment : Fragment() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == ContactsFragment.REQUEST_CODE_NEW_CONVERSATION) {
            if (data == null) return
