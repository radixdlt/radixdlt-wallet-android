...
import com.radixdlt.android.apps.wallet.ui.fragment.payment.input.PaymentInputFragmentArgs
import com.radixdlt.android.apps.wallet.ui.fragment.payment.summary.PaymentSummaryFragment
import com.radixdlt.android.apps.wallet.ui.fragment.payment.summary.PaymentSummaryFragmentArgs
    ...
    private fun navigateTo(fragmentId: Int) {
        when (fragmentId) {
            R.id.navigation_payment_summary -> {
                ...
                // val bundle2 = PaymentInputFragmentArgs.fromBundle(bundle).toBundle()
                graph.startDestination = R.id.navigation_payment_input
                navController.setGraph(graph, bundle)
