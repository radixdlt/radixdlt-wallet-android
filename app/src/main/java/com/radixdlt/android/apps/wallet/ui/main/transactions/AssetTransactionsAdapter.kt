...
class AssetTransactionsAdapter(
    ...
    inner class TransactionsViewHolder(
        ...
        fun bindTransaction(transactionEntity: TransactionEntity) {
        ...
        fun bindTransactionAndDate(transactionEntity: TransactionEntity) {
        ...
        private fun setAccount(transactionEntity2: TransactionEntity) {
        ...
        private fun setTransactionFiatValue(transactionEntity: TransactionEntity) {
            var amount = transactionEntity.amount
                .setScale(2, RoundingMode.HALF_UP)
                .toPlainString()
    ...
    @MainThread
    fun replace(assets: List<TransactionEntity>) {
