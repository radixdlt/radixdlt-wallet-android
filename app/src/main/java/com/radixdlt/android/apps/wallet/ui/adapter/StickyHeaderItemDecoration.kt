...
class StickyHeaderItemDecoration(
    ...
    interface StickyHeaderInterface {
        ...
        /**
         * This method gets called by [StickyHeaderItemDecoration] to fetch the position of the
         * header item in the adapter that is used for (represents) item at specified position.
         *
         * @param itemPosition int. Adapter's position of the item for which to do the search
         * of the position of the header item.
         *
        ...
        /**
         * This method gets called by [StickyHeaderItemDecoration] to get layout resource id for
        ...
        /**
         * This method gets called by [StickyHeaderItemDecoration] to verify whether the item
         * represents a header.
         *
