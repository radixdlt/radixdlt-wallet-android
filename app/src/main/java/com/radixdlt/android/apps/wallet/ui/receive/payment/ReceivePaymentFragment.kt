package com.radixdlt.android.apps.wallet.ui.receive.payment
...
class ReceivePaymentFragment : Fragment() {
    ...
    private val receivePaymentViewModel by viewModels<ReceivePaymentViewModel>(
        factoryProducer = {
            ReceivePaymentViewModelFactory(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ctx = view.context
        (activity as ReceiveActivity).setToolbarVisible()
    ...
    private fun shareAddress() {
        ReceiveActivity.openedShareDialog = true
    ...
    override fun onResume() {
        super.onResume()
        ReceiveActivity.openedShareDialog = false
    }
